...
public:
	...
	//*** Para Textura: aqui adiciono un método que abre la textura en JPGa
	void initialize_textures(void)
	{
		...
		FIBITMAP* bitmap = FreeImage_Load(
			FreeImage_GetFileType("./Mallas/CordylineFREE_BaseColor.png", 0),
			"./Mallas/CordylineFREE_BaseColor.png");
	...
	virtual void OnRender(void)
	{
      ...
      //float timer010 = 0.09; //for screenshot!

      glPushMatrix();
	  glRotatef(timer010 * 180, 0, 0.1f, 0);
	  glTranslatef(0, 0, 0);
	...
	virtual void OnInit()
	{
	 ...
	 //*** Para Textura: abre los shaders para texturas
	  ...
	  if (!objmodel_ptr1)
	  {
		  objmodel_ptr1 = glmReadOBJ("./Mallas/CordylineFREE.obj");
		  if (!objmodel_ptr1)
			  exit(0);
